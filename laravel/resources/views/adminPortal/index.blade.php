...
<body>
            ...
            <div class="content-error">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="./dashboard.blade.php" id="loginForm">
                            <div class="form-group">
                                <label class="control-label" for="username">Username</label>
                                <input type="text" placeholder="John Doe" title="Please enter you username" required=""
    ...
    <!-- jquery
		============================================ -->
    <script src="./../../../public/js/js/vendor/jquery-1.12.4.min.js"></script>
    <!-- bootstrap JS
		============================================ -->
    ...
    <!-- price-slider JS
		============================================ -->
    <script src="./../../../public/js/js/jquery-price-slider.js"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="./../../../public/js/js/jquery.meanmenu.js"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="./../../../public/js/js/owl.carousel.min.js"></script>
    <!-- sticky JS
		============================================ -->
    <script src="./../../../public/js/js/jquery.sticky.js"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="./../../../public/js/js/jquery.scrollUp.min.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="./../../../public/js/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="./../../../public/js/js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="./../../../public/js/js/metisMenu/metisMenu.min.js"></script>
    <script src="./../../../public/js/js/metisMenu/metisMenu-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="./../../../public/js/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="./../../../public/js/js/sparkline/jquery.charts-sparkline.js"></script>

    <!-- maskedinput JS
		============================================ -->
    <script src="./../../../public/js/js/jquery.maskedinput.min.js"></script>
    <script src="./../../../public/js/js/masking-active.js"></script>

    <!-- form validate JS
		============================================ -->
    <script src="./../../../public/js/js/form-validation/jquery.form.min.js"></script>
    <script src="./../../../public/js/js/form-validation/jquery.validate.min.js"></script>
    <script src="./../../../public/js/js/form-validation/form-active.js"></script>
    <!-- dropzone JS
		============================================ -->
    <script src="./../../../public/js/js/dropzone/dropzone.js"></script>
    <!-- tab JS
		============================================ -->
    <script src="./../../../public/js/js/tab.js"></script>
    <!-- plugins JS
		============================================ -->
    <script src="./../../../public/js/js/plugins.js"></script>
    <!-- main JS
		============================================ -->
